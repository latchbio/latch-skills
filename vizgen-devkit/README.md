...
This repo is for the Latch Agent to work specifically with the Vizgen platform.
...
3. Navigate to your tech docs directory and checkout your branch:
   ```bash
   cd /opt/latch/plots-faas/runtime/mount/agent_config/context/technology_docs/vizgen
   git fetch origin
